...
import de.harakal.flaggie.ui.ImageUtils
import de.harakal.flaggie.ui.Stickman
...
/**
 * Activity shows cartoonized live view from Camera
 */
class LiveViewActivity : AppCompatActivity() {
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@LiveViewActivity.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@LiveViewActivity.cameraDevice = null
        }
    ...
    private fun processImage(bitmap: Bitmap) {
        ...
        try {
            stickman.drawStickman(
                ...
                RectSize(MODEL_WIDTH, MODEL_HEIGHT)
            )
        } finally {
