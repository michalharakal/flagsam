...
class Pose2CharStep : Step<Hands, Char?> {
    ...
    private val chars = listOf(
        ...
        CharAngles(Hands(leftHand = 90.0f, rightHand = 90.0f), 'rest'),   //Rest/Space
        CharAngles(Hands(leftHand = 315.0f, rightHand = 270.0f), 'numerals'),
        ...
        CharAngles(Hands(leftHand = 0.0f, rightHand = 270.0f), 'letters'), //=j Letters to follow
        CharAngles(Hands(leftHand = 315.0f, rightHand = 225.0f), 'letters'), //Error/Attention - moving hand
        CharAngles(Hands(leftHand = 45.0f, rightHand = 225.0f), 'letters') //Cancel
